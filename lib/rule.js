...
import { compileGlob, hashText } from './compiler.js';
import { parseParamsDimension, parseAbsentDimension, parseAgentsDimension, parseWhenDimension, parseArgvDimension, parseNetworkDimension, } from './rule-dims.js';
...
export function compileDocument(doc, opts = {}) {
    const comp = (list, action, offset) => list.map((entry, i) => ({
        index: offset + i,
        action,
        reason: entry.reason,

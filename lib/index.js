...
import { Config, RULES_NAMESPACE, RulesSchema, readRulesFromSettings, resolveDshHome, resolveDataDir, ensureDataDir, resolveGatePresets, resolvePermissiveStrategies, resolveRulesFile } from './config.js';
...
export function apply(ctx, config = {}) {
    ...
    let rulesScope;
    const readRulesDocument = () => readRulesFromSettings(rulesScope);

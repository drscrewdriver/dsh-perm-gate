...
> | 0.1.5-rc.1+（専用ライン） | `compat/0.1.5` | `3.x` | `@dsh-0.1.5` |
>
> バージョン系列は **DSH ライン**を追います（`1.x` = DSH ≤ 0.1.1、`2.x` = DSH 0.1.2+、`3.x` = DSH 0.1.5+）。
...
バージョン **3.0.0** — 変更履歴は [日本語 changelog](./CHANGELOG.ja.md) を参照。

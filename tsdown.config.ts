/**
 * Independent tsdown preset for the dsh-perm-gate client half, mirroring
 ...
 * /plugins/dsh-perm-gate/client.js; every @deepseek-ai/* value import must be
 * a platform module (external) or an inline-safe wire layer — this client half
 * only type-imports @deepseek-ai/* packages (erased before the gate), and the
 * purity gate below enforces that.
 */

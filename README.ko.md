...
> | 0.1.5-rc.1+ (전용 라인) | `compat/0.1.5` | `3.x` | `@dsh-0.1.5` |
>
> 버전 계열은 **DSH 라인**을 따릅니다(`1.x` = DSH ≤ 0.1.1, `2.x` = DSH 0.1.2+, `3.x` = DSH 0.1.5+). 메이저
...
버전 **3.0.0** — 변경 내역은 [한국어 changelog](./CHANGELOG.ko.md)를 참고하세요.
